      ...
      <div class="tab-content" id="nav-tabContent">
          ...
          <div class="tab-pane fade" id="insert" role="tabpanel" aria-labelledby="insert-list">
             <?php
			  ...
			  <div class="tab-pane fade" id="display" role="tabpanel" aria-labelledby="display-list">
			 <?php
                    include_once('connect.php');
                    ...
                    <div class="container">
                        <div class="col-md-9 auto">
                            ...
                            <table class="table table-stripped table-hover table-bordered">
                                ...
                                /* @var $q type */
                                $qc = "select * from `tbl_order`";
                                $query2 = mysqli_query($conn, $qc);
              ...
              <div class="container">
                        <div class="col-md-9 auto">
                            ...
                            <table class="table table-stripped table-hover table-bordered">
                                ...
                                /* @var $q type */
                                $qx = "select * from `users`";

                                $query1 = mysqli_query($conn, $qx);
